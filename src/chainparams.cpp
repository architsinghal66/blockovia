...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // BCK: 60 Seconds
        nTargetSpacing = 2 * 60;  // BCK: 120 Seconds
        nLastPOWBlock = 200;
        nMaturity = 10;
	...
	vSeeds.push_back(CDNSSeedData("167.99.196.46", "167.99.196.46"));
	vSeeds.push_back(CDNSSeedData("167.99.83.173", "167.99.83.173"));
        ...
        nStartMasternodePayments = 1521655894; //Wed, 25 Jun 2014 20:36:16 GMT
